...
exp_htg.add_fetcher("results_raw/tyr-1024-2026-1-8-gbfs_lazy-8-eval", filter=normalize_rename_htg)
...
exp_autoscale.add_fetcher("results_raw/tyr-1024-2026-1-8-gbfs_lazy-8-eval", filter=normalize_rename_autoscale)
...
exp.add_fetcher("results_raw/tyr-1024-2026-1-8-gbfs_lazy-8-eval", filter=normalize_rename)
