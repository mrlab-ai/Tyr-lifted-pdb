...
exp = Experiment("gbfs_combine_10_11")
...
exp.add_fetcher("../10-2026-1-8-gbfs_lazy-profiling-classical-combined-eval", filter=rename_algorithm)
exp.add_fetcher("../11-2026-1-8-gbfs_lazy-profiling-classical-combined-eval")
