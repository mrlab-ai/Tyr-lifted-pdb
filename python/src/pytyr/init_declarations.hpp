...
NB_MAKE_OPAQUE(tyr::planning::ProjectionAbstractionList<tyr::planning::LiftedTag>);
NB_MAKE_OPAQUE(tyr::planning::ProjectionAbstractionList<tyr::planning::GroundTag>);
