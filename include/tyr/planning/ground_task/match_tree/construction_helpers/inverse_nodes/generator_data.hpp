...
#ifndef TYR_PLANNING_GROUND_TASK_MATCH_TREE_CONSTRUCTION_HELPERS_INVERSE_NODES_GENERATOR_DATA_HPP_
#define TYR_PLANNING_GROUND_TASK_MATCH_TREE_CONSTRUCTION_HELPERS_INVERSE_NODES_GENERATOR_DATA_HPP_
...
struct Data<planning::match_tree::InverseElementGeneratorNode<Tag>>
{
    Index<planning::match_tree::InverseElementGeneratorNode<Tag>> index;
    IndexList<Tag> elements;

    Data() = default;
    Data(Index<planning::match_tree::InverseElementGeneratorNode<Tag>> index, IndexList<Tag> elements) : index(index), elements(std::move(elements)) {}
