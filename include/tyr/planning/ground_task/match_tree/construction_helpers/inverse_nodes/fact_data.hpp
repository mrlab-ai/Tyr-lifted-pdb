...
#ifndef TYR_PLANNING_GROUND_TASK_MATCH_TREE_CONSTRUCTION_HELPERS_INVERSE_NODES_FACT_DATA_HPP_
#define TYR_PLANNING_GROUND_TASK_MATCH_TREE_CONSTRUCTION_HELPERS_INVERSE_NODES_FACT_DATA_HPP_
...
struct Data<planning::match_tree::InverseFactSelectorNode<Tag>>
{
    Index<planning::match_tree::InverseFactSelectorNode<Tag>> index;
    Data<formalism::FDRFact<formalism::FluentTag>> fact;
    DataList<planning::match_tree::Node<Tag>> children;

    Data() = default;
    Data(Index<planning::match_tree::InverseFactSelectorNode<Tag>> index,
         Data<formalism::FDRFact<formalism::FluentTag>> fact,
         DataList<planning::match_tree::Node<Tag>> children) :
        index(index),
        fact(fact),
