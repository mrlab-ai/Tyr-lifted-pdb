...
#ifndef TYR_PLANNING_GROUND_TASK_MATCH_TREE_CONSTRUCTION_HELPERS_INVERSE_NODES_ATOM_DATA_HPP_
#define TYR_PLANNING_GROUND_TASK_MATCH_TREE_CONSTRUCTION_HELPERS_INVERSE_NODES_ATOM_DATA_HPP_
...
struct Data<planning::match_tree::InverseAtomSelectorNode<Tag>>
{
    ...
    Data() = default;
    Data(Index<planning::match_tree::InverseAtomSelectorNode<Tag>> index,
         Index<formalism::GroundAtom<formalism::DerivedTag>> atom,
         ::cista::optional<Data<planning::match_tree::Node<Tag>>> true_child,
         ::cista::optional<Data<planning::match_tree::Node<Tag>>> false_child,
         ::cista::optional<Data<planning::match_tree::Node<Tag>>> dontcare_child) :
