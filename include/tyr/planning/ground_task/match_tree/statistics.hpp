...
#ifndef TYR_PLANNING_GROUND_TASK_MATCH_TREE_STATISTICS_HPP_
#define TYR_PLANNING_GROUND_TASK_MATCH_TREE_STATISTICS_HPP_
...
extern void parse_generator_distribution_iteratively(const Node<Tag>& root, Statistics& ref_statistics);
