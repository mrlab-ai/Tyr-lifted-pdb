...
{
public:
    PlanningFDRTask(View<Index<FDRTask>, Repository> task, GeneralFDRContext fdr_context, std::shared_ptr<Repository> repository, PlanningDomain domain) :
...
private:
    ...
    View<Index<FDRTask>, Repository> m_task;
